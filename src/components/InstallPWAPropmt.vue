...
onMounted(() => {
  ...
  window.addEventListener('beforeinstallprompt', (event) => {
    ...
    console.log({ event, Cookies: Cookies.get("add-to-home-screen"), installPromptEvent: installPromptEvent.value })
  ...
  <AlertDialog v-model:open="isModalOpen">
    ...
    <AlertDialogContent>
      <AlertDialogHeader>
        ...
        <AlertDialogDescription>
          Add Tracka to your home screen for easy access and an enhanced experience. Enjoy faster load times, offline access, and more by installing now!
        </AlertDialogDescription>
      </AlertDialogHeader>
      <AlertDialogFooter>
